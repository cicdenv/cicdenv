resource "aws_lambda_function" "global_github_oauth_callback" {
  filename      = "github-oauth-callback/lambda.zip"
  function_name = "jenkins-github-oauth-AWS_PROXY"
  role          = aws_iam_role.global_github_oauth_callback.arn
...
resource "aws_lambda_permission" "apigw_lambda" {
  ...
  function_name = aws_lambda_function.global_github_oauth_callback.function_name
