...
def create_keys():
    ...
    return {
        'server-private-key': server_key['private-key'],
        'server-public-key': server_key['public-key'],
        'client-private-key': client_key['private-key'],
        'client-public-key': client_key['public-key'],
    }
