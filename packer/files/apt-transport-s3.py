...
# a705ccc34b2e4c4f123ca9082609a4df10312b94 14-June-2019
...
class AWSCredentials(object):
    ...
    def __init__(self, config_file=None):
        ...
        self.credentials_metadata = urlparse.urljoin(host, path_sec_cred)
        self.instance_metadata = urlparse.urljoin(host, path_instance_metadata)

    def __get_role(self):
        # Read IAM role from AWS metadata store
        request = urllib2.Request(self.credentials_metadata)
